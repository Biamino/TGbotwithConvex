...
CONVEX_URL = "https://fearless-schnauzer-643.convex.cloud"
...
def save_message_to_convex(message_data):
    ...
    try:
        # Отправляем данные в соответствии с новой схемой
        convex_data = {
            "userId": str(message_data.get("userId", "")),
            "recipientId": "telegram_bot",  # ID бота или другой идентификатор
            "content": message_data.get("text", ""),
            "source": "telegram",
            "status": "received",
            "createdAt": message_data.get("timestamp", int(time.time() * 1000)),
